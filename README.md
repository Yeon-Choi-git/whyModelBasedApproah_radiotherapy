...
|                                                                                                                       | Main          | A1             | A2            | A3            |
+=======================================================================================================================+===============+================+===============+===============+
| Is **T-stage** **confounding** doses to OARs and NTCP (dose-outcome relationship)?                                    | `TRUE`        | `TRUE`         | `TRUE`        | `FALSE`       |
|                                                                                                                       |               |                |               |               |
| `tstate_to_dose`                                                                                                      |               |                |               |               |
+-----------------------------------------------------------------------------------------------------------------------+---------------+----------------+---------------+---------------+
| Is **T-stage** an **effect modifier** of the treatment effect?                                                        | `FALSE`       | `FALSE`        | `TRUE`        | `TRUE`        |
|                                                                                                                       |               |                |               |               |
| `tstage_to_dosediff`                                                                                                  |               |                |               |               |
+-----------------------------------------------------------------------------------------------------------------------+---------------+----------------+---------------+---------------+
